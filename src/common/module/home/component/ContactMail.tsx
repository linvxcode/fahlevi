  ...
  return (
    <div className="w-full h-auto bg-neutral-800 py-5 px-10 rounded-3xl mt-5">
      ...
      <Buttons
        ...
        icon={<RiMailSendLine size={20} className="lg:group-hover:text-neutral-700" />}
        icons={<RiMailSendLine size={40}  className="text-neutral-600 lg:group-hover:text-neutral-300 lg:transition-all lg:duration-300" />}
        title="Contact Me"
      />
    </div>
  );
