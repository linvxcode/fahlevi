...
const Fret10 = () => {
  ...
  const fret10: fret10[] = [
    {
      ...
      type: "white",
      className: "bg-white",
      src: "https://firebasestorage.googleapis.com/v0/b/instrument-90e24.appspot.com/o/guitar%2Ftuts%2Ftutsup%2Fd%2B.wav?alt=media&token=4f80a7bb-7579-4702-a63a-75989997daa0",
    },
    // {
    //   note: "ADownn",
    //   label: "ADownn",
  ...
  return (
    <div>
      <div className="w-[60px] left-[540px] h-[210px] top-[-15px] border-r  border-[#000] absolute">
      {fret10.map((key) => (
