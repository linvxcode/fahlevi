  ...
  const pianoKeys: PianoKey[] = [
    {
      ...
      type: "white",
      className: "bg-white",
      src: "/audio/guitar/firsttuts/e+.wav",
    },
    {
      note: "B2",
      label: "B",
      type: "white",
      className: "bg-white",
      src: "/audio/guitar/firsttuts/b+.wav",
    },
    {
      note: "G2",
      label: "G",
      type: "white",
      className: "bg-white",
      src: "/audio/guitar/firsttuts/g+.wav",
    },
    {
      note: "D2",
      label: "D",
      type: "white",
      className: "bg-white",
      src: "/audio/guitar/firsttuts/d+.wav",
    },
    {
      note: "A1",
      label: "A",
      type: "white",
      className: "bg-white",
      src: "/audio/guitar/firsttuts/a+.wav",
    },
    {
      note: "E3",
      label: "E",
      type: "white",
      className: "bg-white",
      src: "/audio/guitar/firsttuts/ee+.wav",
    },
  ];
